...
for weak_ds in weak_ds_list:
    smallest_good_num_points = int(salience_df.loc[weak_ds, "smallest_good_num_points"])  # type: ignore # noqa
    ...
    pairs += [(0, num_oracle) for num_oracle in [10, 100, 300, 1000, 3000, 10_000]]
